...
|------|----------|------|---------|
| Verify base game | `steam.getAppDetails({ appid })` | None | Confirm game exists and check current DLC listings |
| Competitor DLC research | `steam.searchApps({ term })` | None | Find competitor games to benchmark DLC pricing |
